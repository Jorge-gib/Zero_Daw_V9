    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('licencia_automotriz', models.ImageField(blank=True, null=True, upload_to='licencias/', verbose_name='Licencia automotriz')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_material', models.CharField(choices=[('Plastico', 'Plastico'), ('Vidrio', 'Vidrio'), ('Carton', 'Carton'), ('Aluminio', 'Aluminio')], max_length=200, null=True)),
                ...
                ('id_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Registro.usermodelo')),
            ],
        ),
        migrations.CreateModel(
